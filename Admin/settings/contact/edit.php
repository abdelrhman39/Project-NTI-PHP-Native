   ...
   // $password = CleanInputs($_POST['password']);
    ...
    if(count($errors) > 0){
     ...
     //$password = md5($password);
      ...
      $sql = "update users  set full_name = '$name' ,email = '$email',role = $role_id where id =".$id;
      $op  = mysqli_query($con,$sql);
            ...
            <div class="container-fluid">
                ...
                <form method="post" action="edit.php?id=<?php echo $data['id'];?>"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" value="<?php echo $data['full_name'];?>" class="form-control" id="exampleInputName" aria-describedby=""
                    ...
                    <div class="form-group">
                        ...
                        <select name="role_id" class="form-control">
                            ...
                            <option value="<?php echo $result['id'];?>" <?php if($data['role'] == $result['id']){ echo 'selected';} ?>><?php echo $result['title'];?></option>
                            <?php }?>
                        </select>
                    </div>
