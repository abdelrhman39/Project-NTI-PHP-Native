...
$result = mysqli_query($con,$sql);
  ...
  while ($row = mysqli_fetch_assoc($result)) {
    //Data Product
      ...
      $is_accepted_id       = $row['is_accepted'];
      $type_id           = $row['type_id'];
...
<form action="update.php" method="POST" enctype='multipart/form-data' class="needs-validation" novalidate>
          ...
          <input type="hidden" name="type_id" value="<?php echo $type_id; ?>">
              ...
              <div class="form-row">
                  ...
                  <div class="col-md-6 mb-3">
                      <img width="100px" src="<?php echo FUrl($img_url);?>" >
                  ...
                  <div class="col-md-6 mb-3">
                      <img width="100px" src="<?php echo FUrl($img_url2);?>" >
                  ...
                  <div class="col-md-6 mb-3">
                      <img width="100px" src="<?php echo FUrl($img_url3);?>" >
                  ...
                  <div class="col-md-6 mb-3">
                  <img width="100px" src="<?php echo FUrl($floor_plans_img);?>" >
                  ...
                  <div class="col-md-6 mb-3">
                      <label for="validationCustom04">City</label>
                      <select name="is_accepted" class="custom-select" id="validationCustom04" >
                        ...
                        <?php
                            ...
                            if( $is_accepted_id ==1){
                                ...
                                echo '<option value="0" selected>NOT Accepted</option>
