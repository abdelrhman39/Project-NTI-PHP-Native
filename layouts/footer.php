    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Shpping Cart</h5>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  ?>
                    ...
                    <tr class="border-bottom mt-3 ">
                        <td class="w-25 text-left"><img src="profile_sett/<?php echo $row['img_url'] ?>" class="w-50"></td>
                        <td class="text-left"><?php echo $row['property_name']; ?></td>
                        <td class="text-left"><?php echo $row['quantity']; ?></td>
                        <td class="text-center"><?php echo $row['price'] * $row['quantity']; ?>$</td>
                        <td class="text-right">
                            <a href="op_property/del_property.php?id=<?php echo $row['cart_id'];?>" class="close" aria-label="Close">
                                    <span aria-hidden="true">&times;</span> 
                            </a>
                        </td>
                    </tr>
            ...
            <div class="modal-footer">
                ...
                <a href="orders.php" type="button" class="btn btn-success">CheckOut</a>
            </div>
        </div>
    </div>
</div>

<!---- End Modal Shpping Cart------>
